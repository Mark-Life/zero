...
static const StdHelperInfo std_helpers[] = {
  ...
  {"std.codec.readI32Le", "i32", 2, "codec", "target-neutral", "little-endian i32 read from byte view", true},
  {"std.codec.readU32Le", "u32", 2, "codec", "target-neutral", "little-endian u32 read from byte view", true},
  ...
  {"std.mem.bytesAsF32", "Span<f32>", 1, "memory", "target-neutral", "reinterprets borrowed bytes as f32; no copy", false},
  ...
  {"std.mem.bytesAsI8", "Span<i8>", 1, "memory", "target-neutral", "reinterprets borrowed bytes as i8; no copy", false},
  {"std.mem.bytesAsMutI8", "MutSpan<i8>", 1, "memory", "target-neutral", "reinterprets borrowed bytes as mutable i8; no copy", false},
