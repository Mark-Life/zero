...
void z_x64_emit_load_reg_ptr_reg_disp(ZBuf *buf, unsigned dst_reg, unsigned base_reg, unsigned disp, bool wide);
void z_x64_emit_movsx_reg32_ptr_reg_i8(ZBuf *buf, unsigned dst_reg, unsigned base_reg);
...
void z_x64_emit_store_ptr_reg_disp_from_reg(ZBuf *buf, unsigned base_reg, unsigned disp, unsigned src_reg, bool wide);
