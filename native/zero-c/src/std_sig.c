...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  {"std.codec.readI32Le", "i32", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readU32Le", "u32", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readU16Le", "u16", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readI64Le", "i64", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readU64Le", "u64", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readF32Le", "f32", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  {"std.codec.readF64Le", "f64", 2, {"Span<u8>", "usize"}, {NULL}, "codec", "target-neutral", "little-endian read at byte offset", false, Z_STD_HELPER_KIND_TABLE},
  ...
  {"std.mem.bytesAsF32", "Span<f32>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as f32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsF64", "Span<f64>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as f64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsI32", "Span<i32>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as i32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsU32", "Span<u32>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as u32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsI8", "Span<i8>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as i8; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsI64", "Span<i64>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as i64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsU64", "Span<u64>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as u64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsU8", "Span<u8>", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as u8; no copy (strips mutability)", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutF32", "MutSpan<f32>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable f32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutF64", "MutSpan<f64>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable f64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutI32", "MutSpan<i32>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable i32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutU32", "MutSpan<u32>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable u32; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutI8", "MutSpan<i8>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable i8; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutI64", "MutSpan<i64>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable i64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutU64", "MutSpan<u64>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed bytes as mutable u64; no copy", false, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.bytesAsMutU8", "MutSpan<u8>", 1, {"MutSpan<u8>"}, {NULL}, "memory", "target-neutral", "reinterprets borrowed mutable bytes as mutable u8; no copy", false, Z_STD_HELPER_KIND_TABLE},
  ...
  {"std.fs.mmap", "Maybe<owned<Mapping>>", 2, {"Fs", "String"}, {NULL}, "fs", "host", "read-only file memory mapping", true, Z_STD_HELPER_KIND_TABLE},
  {"std.fs.mappingBytes", "Span<u8>", 1, {"ref<Mapping>"}, {NULL}, "fs", "host", "borrows mapped bytes", false, Z_STD_HELPER_KIND_TABLE},
  {"std.fs.munmap", "Void", 1, {"mutref<Mapping>"}, {NULL}, "fs", "host", "unmaps the file mapping", true, Z_STD_HELPER_KIND_TABLE},
  {"std.math.sqrtf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.expf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.cosf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.sinf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.powf", "f32", 2, {"f32", "f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.absf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.floorf", "f32", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.isNaNf", "Bool", 1, {"f32"}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.piF", "f32", 0, {NULL}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.eF", "f32", 0, {NULL}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.infinityF", "f32", 0, {NULL}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
  {"std.math.nanF", "f32", 0, {NULL}, {NULL}, "math", "target-neutral", "no allocation", false, Z_STD_HELPER_KIND_TABLE},
