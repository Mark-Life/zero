...
const fileBudgets = {
  "native/zero-c/include/zero.h": { maxLines: 1000, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_runtime.h": { maxLines: 100, maxStrcmpCalls: 0 },
  "native/zero-c/src/checker.c": { maxLines: 9420, maxStrcmpCalls: 279 },
  "native/zero-c/src/main.c": { maxLines: 9960, maxStrcmpCalls: 442 },
  "native/zero-c/src/ir.c": { maxLines: 4470, maxStrcmpCalls: 280 },
  "native/zero-c/src/row_syntax.c": { maxLines: 2150, maxStrcmpCalls: 11 },
  "native/zero-c/src/ast.c": { maxLines: 250, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability.c": { maxLines: 480, maxStrcmpCalls: 2 },
  ...
  "native/zero-c/src/buildability_targets.c": { maxLines: 210, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability_value_targets.c": { maxLines: 425, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/coff_format.c": { maxLines: 460, maxStrcmpCalls: 1 },
  "native/zero-c/src/coff_format.h": { maxLines: 130, maxStrcmpCalls: 0 },
  "native/zero-c/src/coff_emit_state.c": { maxLines: 305, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/elf_emit_state.h": { maxLines: 100, maxStrcmpCalls: 0 },
  ...
  // +~1600 over the pre-llama2 baseline: f32/f64 lowering, std.math/libm call patches,
  // and the fs.mmap/page-alloc runtime stanzas for the aarch64 direct backend.
  "native/zero-c/src/aarch64_direct.c": { maxLines: 2310, maxStrcmpCalls: 2 },
  "native/zero-c/src/aarch64_direct.h": { maxLines: 65, maxStrcmpCalls: 0 },
  "native/zero-c/src/aarch64_emit.c": { maxLines: 485, maxStrcmpCalls: 0 },
  "native/zero-c/src/aarch64_emit.h": { maxLines: 100, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_macho64.c": { maxLines: 2740, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2470, maxStrcmpCalls: 2 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 330, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 150, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_elf64.c": { maxLines: 3040, maxStrcmpCalls: 3 },
  // +~30 for the direct-exe guards: refuse an exe with unresolved libm calls, and
  // reject a branch26 to a callee that was never emitted (mirrors the object path).
  "native/zero-c/src/emit_elf_aarch64.c": { maxLines: 505, maxStrcmpCalls: 1 },
  // +~1000 over the pre-llama2 baseline: Win64 XMM float-arg ABI, inline std.math,
  // and the kernel32 mmap/munmap import-bake + reloc stanzas for the COFF x64 backend.
  "native/zero-c/src/emit_coff.c": { maxLines: 1985, maxStrcmpCalls: 1 },
  // +~20 for the same direct-exe branch26-to-un-emitted-callee guard as the elf path.
  "native/zero-c/src/emit_coff_aarch64.c": { maxLines: 620, maxStrcmpCalls: 0 },
  "native/zero-c/src/fs.c": { maxLines: 1250, maxStrcmpCalls: 32 },
  "native/zero-c/src/mir_verify.c": { maxLines: 1370, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 255, maxStrcmpCalls: 2 },
  ...
  "native/zero-c/src/target.c": { maxLines: 495, maxStrcmpCalls: 22 },
  ...
  "native/zero-c/src/x64_emit.c": { maxLines: 1170, maxStrcmpCalls: 0 },
  "native/zero-c/src/x64_emit.h": { maxLines: 147, maxStrcmpCalls: 0 },
};

const knownLargeFunctionLimits = new Map([
  ["native/zero-c/src/ir.c|static bool ir_lower_expr(const Program *program, IrProgram *ir, const IrFunction *fun, const Expr *expr, IrValue **out) {", 1820],
  ["native/zero-c/src/ir.c|static bool ir_lower_byte_view(const Program *program, IrProgram *ir, const IrFunction *fun, const Expr *expr, IrValue **out) {", 165],
  ["native/zero-c/src/checker.c|static bool check_expr_expected(CheckContext *ctx, const Program *program, const Expr *expr, Scope *scope, ZDiag *diag, const char *expected) {", 560],
  ["native/zero-c/src/main.c|int main(int argc, char **argv) {", 924],
  ["native/zero-c/src/main.c|static void append_graph_json(ZBuf *buf, SourceInput *input, Program *program, const ZTargetInfo *target, const Command *command) {", 378],
  ...
  ["native/zero-c/src/ir.c|static bool ir_lower_stmt_to_vec(const Program *program, IrProgram *ir, IrFunction *mir_fun, const Stmt *stmt, IrInstr **out_items, size_t *out_len, size_t *out_cap, bool *saw_return) {", 250],
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_value_kind_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 155],
  ...
  ["native/zero-c/src/emit_elf_aarch64.c|bool z_emit_elf_aarch64_object_from_ir(const IrProgram *ir, ZBuf *out, ZDiag *diag) {", 240],
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_float_value_to_vreg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned vreg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 140],
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 145],
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_instr(ZBuf *text, const IrFunction *fun, const IrInstr *instr, unsigned frame_size, bool restore_process_args, MachOEmitContext *ctx, ZDiag *diag) {", 250],
  ["native/zero-c/src/buildability.c|static bool build_value_supported(const ZBuildability *ctx, const IrValue *value, bool local_set_value) {", 220],
  ["native/zero-c/src/aarch64_direct.c|static bool a64_emit_float_value_to_vreg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned vreg, unsigned frame_size, unsigned scratch_slot, ZAArch64DirectContext *ctx, ZDiag *diag) {", 145],
  ["native/zero-c/src/emit_coff_aarch64.c|bool z_emit_coff_aarch64_object_from_ir(const IrProgram *program, ZBuf *out, ZDiag *diag) {", 190],
  ["native/zero-c/src/emit_coff_aarch64.c|bool z_emit_coff_aarch64_exe_from_ir(const IrProgram *program, ZBuf *out, ZDiag *diag) {", 145],
  // grew for the function_emitted[] tracking + branch26-to-un-emitted-callee guard.
  ["native/zero-c/src/emit_elf_aarch64.c|bool z_emit_elf_aarch64_exe_from_ir(const IrProgram *ir, ZBuf *out, ZDiag *diag) {", 130],
  // kernel32 mmap externals add a parallel symbol-bake + reloc-append stanza beneath the
  // existing math/world-write tables in z_emit_coff_x64_object_from_ir.
  ["native/zero-c/src/emit_coff.c|bool z_emit_coff_x64_object_from_ir(const IrProgram *program, ZBuf *out, ZDiag *diag) {", 140],
]);
